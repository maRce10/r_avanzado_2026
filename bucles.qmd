...
flowchart LR
    ...
    A("Inicio del bucle") --> B("¿Se cumple la condición?")
    B -- Sí --> C(Realizar tarea)
    C --> D(Guardar resultado)
    D --> F(Modifica objeto evaluado)
    F --> B
    B -- No --> E(Fin del bucle)
    ...
    style C fill:#348AA666, stroke:#000, stroke-width:2px, color:#FFF
    style D fill:#357BA266, stroke:#000, stroke-width:2px, color:#FFF
    style D fill:#49C1AD66, stroke:#000, stroke-width:2px, color:#FFF
...
1.6 ¿Cuál es la correlación entre el número de familias y la profundidad? (Utilice el data frame generado para responder esta pregunta)
...
flowchart LR
    ...
    A("Inicio del bucle") --> B("¿Se cumple la condición?")
    B -- No --> C(Realizar tarea)
    C --> D(Guardar resultado)
    D --> F(Modifica objeto evaluado)
    F --> B
    B -- Sí --> E(Fin del bucle)
