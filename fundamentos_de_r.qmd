...
flowchart LR
    ...
    subgraph Cuerpo
    B --> C("Enunciado de retorno</br>return()")
    end
    C --> D(Resultado)

    style A fill:#F98C0A80, stroke:#000, stroke-width:0.5px
    style B fill:#BEBEBE1A, stroke:#000, stroke-width:2px
    style C fill:#BEBEBE1A, stroke:#000, stroke-width:2px
...
flowchart LR
    ...
    B -- falso --> D(Tarea 2)
    C --> E("Enunciado de retorno</br>return()")
    D --> E
    end
    E --> F(Resultado)
